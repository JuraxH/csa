...
RE2_SRC = re2/glushkov.cc re2/csa.cc re2/compile.cc re2/parse.cc re2/perl_groups.cc re2/prog.cc re2/re2.cc re2/regexp.cc re2/simplify.cc re2/stringpiece.cc re2/tostring.cc re2/unicode_casefold.cc re2/unicode_groups.cc
RE2_OBJ = build/glushkov.o build/csa.o build/compile.o build/parse.o build/perl_groups.o build/prog.o build/re2.o build/regexp.o build/simplify.o build/stringpiece.o build/tostring.o build/unicode_casefold.o build/unicode_groups.o
